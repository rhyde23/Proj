...
if not pi :
    keyboard_order = {
        ...
        pygame.K_DELETE:pygame.image.load('C:\\Users\\rhyde23\\Desktop\\Project\\Images\\Page-028.png').convert(),
...
if pi :
    keyboard_order = {
        ...
        pygame.K_DELETE:pygame.image.load(convert_path('C:\\Users\\rhyde23\\Desktop\\Project\\Images\\Page-028.png')).convert(),
